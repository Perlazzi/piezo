...
\begin{tikzpicture}[scale=0.8,line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
  \node (root) at (0,0) {$[\DD_{2n}^h]\circledcirc [\ico\oplus \ZZ_2^c]$};

  \node (Bas1) at (-5,-2.5) {\begin{tabular}{l} $[\1],[\ZZ_2]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
  \node (Bas2) at (-2,-2.5)   {\begin{tabular}{l} $[\1],[\ZZ_2^-]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
  \node (Bas3) at (0.5,-2.5) {\begin{tabular}{l} $[\1],[\ZZ_3]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
  \node (Bas4) at (3,-2.5) {\begin{tabular}{l} $[\1],[\ZZ_5]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
  \node (Bas5) at (5.3,-2.5) {\begin{tabular}{l} $[\1]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
