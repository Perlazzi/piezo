...
\begin{tikzpicture}[scale=0.8,line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
  ...
  \node (Bas1) at (-3.5,-2.5) {\begin{tabular}{l} $[\1]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
  \node (Bas2) at (-1,-2.5)   {\begin{tabular}{l} $[\1],[\ZZ_3]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
  \node (Bas3) at (1.5,-2.5) {\begin{tabular}{l} $[\1],[\ZZ_2]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
  \node (Bas4) at (4.5,-2.5) {\begin{tabular}{l} $[\1],[\ZZ_2]$ \\ $[\ZZ_2^{b_i}],[\ZZ_2^{b_i-}]$\end{tabular}};
